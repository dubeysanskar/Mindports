            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                <Link to="/" className="flex items-center">
                  ...
                  <span className="ml-2 text-xl font-bold text-white">EduPath AI</span>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400 mb-4">Transform Your Learning Journey.</p>
            ...
            <div className="border-t border-blue-900/30 mt-8 pt-8 text-center">
              <p className="text-gray-400">&copy; {new Date().getFullYear()} EduPath AI. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
  ...
  return (
    <main className="pt-24 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        ...
        Transform Your Learning Journey Now
        </h1>
        <p className="text-xl text-gray-400 max-w-3xl mx-auto">
        Personalized learning paths that adapt to your progress and learning style in real-time. powered by AI.
        </p>
      </div>
